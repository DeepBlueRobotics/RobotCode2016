...
public class NewClass extends StaticWidget {
    ...
    public void init() {
        ...
        Defense[0].setPreferredSize(new Dimension(150, 25));
        Defense[1].setPreferredSize(new Dimension(150, 25));
        Defense[2].setPreferredSize(new Dimension(150, 25));
        Defense[3].setPreferredSize(new Dimension(150, 25));
